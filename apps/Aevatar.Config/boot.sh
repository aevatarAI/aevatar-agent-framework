...
# ============================================================
#  Aevatar.Config - restart helper
#
#  What it does:
#  - Kill processes listening on ports 6667 and 6677 (TERM then KILL if needed)
#  - Start Aevatar.Config, forcing ASPNETCORE_URLS to those ports
#
#  Usage:
#    ./restart.sh
#    ./restart.sh --no-build
...
PROJECT_PATH="$SCRIPT_DIR/Aevatar.Config.csproj"
