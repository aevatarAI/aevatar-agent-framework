...
public sealed class WorkspaceService
{
    ...
    private string ResolveSystemRoot()
    {
        ...
        // Generic override (optional).
        var genericRoot = Environment.GetEnvironmentVariable("AEVATAR_WORKSPACE_ROOT");
        if (!string.IsNullOrWhiteSpace(genericRoot))
        {
            var resolved = Path.GetFullPath(genericRoot.Trim());
