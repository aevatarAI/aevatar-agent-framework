...
public abstract partial class AIGAgentBase
{
    ...
    {
        return await AgentSkillsRuntime.ExecuteSkillsFilesToolAsync(parameters, executionContext, cancellationToken);
    }
    ...
    private async Task<IMessage> ExecuteSkillsReadFileToolAsync(
        ...
        CancellationToken cancellationToken)
    {
        return await AgentSkillsRuntime.ExecuteSkillsReadFileToolAsync(
            parameters,
            executionContext,
    ...
    private async Task<IMessage> ExecuteSkillsRunPythonToolAsync(
        ...
        CancellationToken cancellationToken)
    {
        return await AgentSkillsRuntime.ExecuteSkillsRunPythonToolAsync(
            parameters,
            executionContext,
            HookOptions.MaxToolOutputChars,
            cancellationToken);
    ...
    {
        return AgentSkillsRuntime.FindSkillByName(name, cancellationToken);
    }

    private static string? ResolvePathUnderRoot(string rootDirFull, string relativePath)
    {
        return AgentSkillsRuntime.ResolvePathUnderRoot(rootDirFull, relativePath);
    }
