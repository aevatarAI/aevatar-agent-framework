...
// ============================================================
//  DeliveryCenterRepository (File-SSoT)
//
...
public sealed class DeliveryCenterRepository : IDeliveryCenterRepository
{
    ...
    private readonly ILogger<DeliveryCenterRepository> _logger;

    public DeliveryCenterRepository(WorkspaceService workspace, ILogger<DeliveryCenterRepository> logger)
    {
    ...
    public Task<SraDeliveryCenterSnapshot> GetSnapshotAsync(string sessionId, CancellationToken ct)
        => LoadDeliverySnapshotAsync(sessionId, ct);
