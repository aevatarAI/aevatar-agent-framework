...
public sealed class BriefRepository : IBriefRepository
{
    ...
    private readonly ILogger<BriefRepository> _logger;

    public BriefRepository(WorkspaceService workspace, ILogger<BriefRepository> logger)
    {
