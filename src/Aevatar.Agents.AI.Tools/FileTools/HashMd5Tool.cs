...
public sealed class HashMd5Tool : AevatarToolBase
{
    private readonly FileToolOptions _options;

    public HashMd5Tool(FileToolOptions options)
    {
        _options = options ?? FileToolOptions.Empty;
    }

    public override string Name => "hash_md5";
    public override string Description => "Compute MD5 hash of text or file.";
