/*aevatar_tool
{
  "name": "weex_ai_market_depth",
  "description": "WEEX AI Wars MARKET API: GET /capi/v2/market/depth (docs: https://www.weex.com/api-doc/contract/Market_API/GetDepthData)",
  "category": "Custom",
  "version": "0.1.0",
  "tags": [
    "weex",
  ...
  "parameters": {
    ...
    "items": {
      ...
      "limit": {
        "type": "integer",
        "required": false,
        "description": "Fixed gear enumeration value: 15/200, the default gear is 15"
      }
    }
  }
}
...
const string requestPath = "/capi/v2/market/depth";
var method = "GET";
