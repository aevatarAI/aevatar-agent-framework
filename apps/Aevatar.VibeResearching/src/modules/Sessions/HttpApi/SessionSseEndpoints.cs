...
/// <summary>
/// Server-Sent Events (SSE) endpoints for real-time session updates.
/// Provides AG-UI protocol event streaming for research sessions.
/// </summary>
public static class SessionSseEndpoints
{
    private static readonly JsonSerializerOptions Json = new() { PropertyNamingPolicy = JsonNamingPolicy.CamelCase };

    /// <summary>
    /// Maps the session SSE endpoints.
    /// </summary>
    /// <param name="app">The endpoint route builder.</param>
    /// <returns>The endpoint route builder for chaining.</returns>
    public static IEndpointRouteBuilder MapSessionSseEndpoints(this IEndpointRouteBuilder app)
    {
        app.MapGet("/api/sessions/{sessionId}/agui/events", HandleAgUiEventsAsync)
    ...
    private static async Task HandleAgUiEventsAsync(
        HttpContext http,
        string sessionId,
        [FromServices] ResearchSessionManager sessions,
        [FromServices] SessionUiSnapshotStore ui,
        [FromServices] AgentProvidersStore agentProviders,
        [FromServices] IBriefRepository brief,
        [FromServices] IDeliveryCenterRepository delivery,
        [FromServices] IDagStore dag,
        [FromServices] ITraceRepository trace,
        [FromServices] IWorkspaceService workspace,
        [FromServices] ResearchRuntime runtime,
