        ...
        CancellationToken ct)
    {
        ...
        if (parsed.PaperPatches is { Count: > 0 })
        {
            ...
            foreach (var p in parsed.PaperPatches.Take(3))
            {
                ...
                {
                    "outline" => Agents.Contracts.Collab.PaperTargetFile.Outline,
                    "draft" => Agents.Contracts.Collab.PaperTargetFile.Draft,
                    _ => Agents.Contracts.Collab.PaperTargetFile.Draft
                };
                ...
                var proposal = new PaperPatchProposal
                {
                    ...
                    Format = Agents.Contracts.Collab.PaperPatchFormat.ReplaceSpan,
