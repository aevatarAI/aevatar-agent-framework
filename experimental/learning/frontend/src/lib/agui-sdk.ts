...
//
// WHY:
// - The real "@agui/sdk" may not be available on npmjs.org in some environments.
// - We keep a small shim so the Learning frontend stays runnable without private registries.
//
// Behavior:
// - Connects to an AG-UI SSE endpoint (events with JSON payload in `data:` lines).
