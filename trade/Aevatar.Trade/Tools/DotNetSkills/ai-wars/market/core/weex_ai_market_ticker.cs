/*aevatar_tool
{
  "name": "weex_ai_market_ticker",
  "description": "WEEX AI Wars MARKET API: GET /capi/v2/market/ticker (docs: https://www.weex.com/api-doc/contract/Market_API/GetTickerInfo)",
  "category": "Custom",
  "version": "0.1.0",
  "tags": [
    "weex",
...
const string requestPath = "/capi/v2/market/ticker";
var method = "GET";
