...
- `apps/Aevatar.Trading/Aevatar.Trade/Agents/Data/DataCollectorAgent.cs`：REST polling 间隔
- `apps/Aevatar.Trading/Aevatar.Trade/Agents/Analysts/MarketSentimentAgent.cs`：`MinAnalysisIntervalSeconds`
- `apps/Aevatar.Trading/Aevatar.Trade/Agents/Analysts/TechnicalAnalystAgent.cs`：`MinAnalysisIntervalSeconds`
- `apps/Aevatar.Trading/Aevatar.Trade/Agents/Coordinator/TradingCoordinatorAgent.cs`：`DecisionMinIntervalSeconds`
...
- [x] Week 4: 优化 + 演示准备 ✅
  ...
  - [x] 创建 Aspire AppHost
  - [ ] 集成测试
  - [x] 演示 UI（apps/Aevatar.Trading/frontend）
  - [ ] 演示视频
