/*aevatar_tool
{
  "name": "weex_ai_market_trades",
  "description": "WEEX AI Wars MARKET API: GET /capi/v2/market/trades (docs: https://www.weex.com/api-doc/contract/Market_API/GetTradeData)",
  "category": "Custom",
  "version": "0.1.0",
  "tags": [
    "weex",
...
const string requestPath = "/capi/v2/market/trades";
var method = "GET";
