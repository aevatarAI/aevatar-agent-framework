...
```bash
./experimental/learning/boot.sh --web
```
...
```bash
dotnet run --project experimental/learning/Aevatar.Learning.AppHost
```
...
```bash
cd experimental/learning/src/Aevatar.Learning.Api
...
```bash
cd experimental/learning/frontend
...
- 详细说明见：`experimental/learning/docs/CONFIGURATION.md`
...
- 架构：`experimental/learning/docs/ARCHITECTURE.md`
- 配置：`experimental/learning/docs/CONFIGURATION.md`
- 开发：`experimental/learning/docs/DEVELOPMENT.md`
