/*aevatar_tool
{
  "name": "weex_ai_market_get_history_fund_rate",
  "description": "WEEX AI Wars MARKET API: GET /capi/v2/market/getHistoryFundRate (docs: https://www.weex.com/api-doc/contract/Market_API/GetContractFundingHistory)",
  "category": "Custom",
  "version": "0.1.0",
  "tags": [
    "weex",
  ...
  "parameters": {
    ...
    "items": {
      ...
      "limit": {
        "type": "integer",
        "required": false,
        "description": "The size of the data ranges from 1 to 100, with a default of 10"
      }
    }
  }
}
...
var required = new[] { "symbol" };
EnsureRequired(root, required);

const string requestPath = "/capi/v2/market/getHistoryFundRate";
var method = "GET";

var allParams = new[] { "symbol", "limit" };
