...
public sealed class VibeMilestoneLoopRunner
{
    ...
    private readonly IBriefRepository _brief;
    private readonly IDagStore _dag;
    ...
    internal async Task<MilestoneLoopResult> ExecuteByMilestonesAsync(
