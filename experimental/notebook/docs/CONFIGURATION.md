...
- **主配置**：`experimental/notebook/src/Aevatar.Notebook.Api/appsettings.json`
...
- **可选项目级 secrets（gitignored）**：`experimental/notebook/src/Aevatar.Notebook.Api/appsettings.secrets.json`
  - 示例：`experimental/notebook/src/Aevatar.Notebook.Api/appsettings.secrets.json.example`
...
```bash
cd experimental/notebook/src/Aevatar.Notebook.Api
