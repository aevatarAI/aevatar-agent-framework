...
- [-] 2. Implement Claude Agent SDK runner (process execution + bounded I/O + cancellation)
  - Files:
...
- [ ] 3. Implement `ClaudeAgentSdkProvider` (IAevatarLLMProvider) on top of the runner
  - Files:
...
- [ ] 4. Wire `claude_agent_sdk` into `LLMTornadoProviderFactory` selection logic
  - Files:
...
- [ ] 5. Add unit tests for config parsing + factory selection + protocol parsing
  - Files:
...
- [ ] 6. Documentation + examples for enabling `claude_agent_sdk` provider
  - Files:
