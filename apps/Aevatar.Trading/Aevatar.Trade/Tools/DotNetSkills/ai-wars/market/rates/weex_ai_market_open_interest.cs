/*aevatar_tool
{
  "name": "weex_ai_market_open_interest",
  "description": "WEEX AI Wars MARKET API: GET /capi/v2/market/open_interest (docs: https://www.weex.com/api-doc/contract/Market_API/GetTotalPlatformOpenInterest)",
  "category": "Custom",
  "version": "0.1.0",
  "tags": [
    "weex",
...
const string requestPath = "/capi/v2/market/open_interest";
var method = "GET";

var allParams = new[] { "symbol" };
