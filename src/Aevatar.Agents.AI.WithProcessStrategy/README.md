...
Pluggable processing/strategy extensions for AI agents (policy, orchestration, and execution strategies).
...
- `StrategyDecision`
- `AIGAgentWithProcessStrategy`
- `TreeOfThoughtsProcessingStrategy`
- `AevatarAIProcessingStrategyFactory`
- `AevatarAIProcessingStrategyExtensions`
- `StandardProcessingStrategy`
- `ReActProcessingStrategy`
- `ChainOfThoughtProcessingStrategy`
- `IAevatarAIProcessingStrategy`
- `IAevatarAIProcessingStrategyFactory`
...
```bash
dotnet build src/Aevatar.Agents.AI.WithProcessStrategy/Aevatar.Agents.AI.WithProcessStrategy.csproj
```
