...
> 目标：`learning/` 必须“包含 notebook 的全部功能”（上传资料、问答、整理报告等）。  
...
|---|---|---|---|
| Sources 上传/创建/列表/读取 | `notebook/src/Aevatar.Notebook.Api/Sources/*` | `learning/src/Aevatar.Learning.Api/Sources/*` | 重写 API，但复用分块/索引算法 |
