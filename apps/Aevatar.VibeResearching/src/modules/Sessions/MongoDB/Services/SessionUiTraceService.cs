...
/// <summary>
/// Session UI trace recorder service implementation.
///
/// Responsibilities:
...
/// </summary>
public sealed class SessionUiTraceService : ISessionUiTraceService
{
    ...
    private readonly ILogger<SessionUiTraceService> _logger;

    private readonly ConcurrentDictionary<string, byte> _attached = new(StringComparer.Ordinal);

    public SessionUiTraceService(SessionUiSnapshotStore store, ILogger<SessionUiTraceService> logger)
    {
