...
/// <summary>
/// Review Agent minimal API endpoints for status, settings, iterations, and SSE streaming.
/// Provides comprehensive review agent operations and real-time event streaming.
/// </summary>
public static class ReviewAgentEndpoints
{
    /// <summary>
    /// Maps all Review Agent endpoints including SSE streaming.
    /// </summary>
    /// <param name="app">The endpoint route builder.</param>
    /// <returns>The endpoint route builder for chaining.</returns>
    public static IEndpointRouteBuilder MapReviewAgentEndpoints(this IEndpointRouteBuilder app)
    {
        var group = app.MapGroup("/api/review-agent")
