...
- [ ] 1. Add Protobuf contracts for file-mailbox + fact lifecycle + paper patches
...
- [ ] 2. Create Contracts project to host generated Protobuf code
...
- [ ] 3. Implement WorkspaceService (file-backed session root + bounded scan)
...
- [ ] 4. Implement FileMailboxService (atomic send + in→processing lock + archive + dead-letter)
...
- [ ] 5. Implement PaperService + PaperEditor flow (Markdown single-writer)
...
- [ ] 6. Implement FactLifecycleService (facts_proposed + decisions + promote)
...
- [ ] 7. Wire Workspace/Proposed Facts into API (session create + facts endpoint behavior change)
...
- [ ] 8. Convert AG-UI STATE_SNAPSHOT to be file-backed
...
- [ ] 9. Add minimal integration tests for the file-backed workflow
