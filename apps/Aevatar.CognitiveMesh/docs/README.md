...
apps/Aevatar.AxiomReasoning/
├── src/Aevatar.AxiomReasoning/             # 公理推理应用
└── AxiomReasoning.AppHost/

apps/Aevatar.PaperReview/
├── src/Aevatar.PaperReview/                # 论文评审应用
└── PaperReview.AppHost/

src/
├── Aevatar.Agents.Cognitive.Core/          # 核心抽象接口
...
cat > apps/Aevatar.CognitiveMesh/src/Aevatar.CognitiveMesh/appsettings.secrets.json << 'EOF'
{
  "LLMProviders": {
    "Providers": {
