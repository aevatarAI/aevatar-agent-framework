...
public sealed class MeshExecutionRunner
{
    ...
    public MeshExecutionRunner(IResearchingRuntime runtime, ILogger<MeshExecutionRunner> logger)
    {
        _runtime = runtime ?? throw new ArgumentNullException(nameof(runtime));
        _logger = logger ?? throw new ArgumentNullException(nameof(logger));
    }

    internal async Task<MeshRunResult> ExecuteAsync(
        ...
        CancellationToken ct)
    {
        ...
        foreach (var nodeId in plan.TopoOrder)
        {
            ...
            // Use vibe.{role} format to match VibeRoundServices worker pattern for frontend recognition
    ...
    // ------------------------------------------------------------
    //  AG-UI message helpers (copied from VibeRoundServices worker patterns)
    // ------------------------------------------------------------
    ...
    // ------------------------------------------------------------
    //  Agent Status Reporting (matches VibeRoundServices worker pattern)
    // ------------------------------------------------------------
