...
使用示例：
  python3 apps/Aevatar.Trading/scripts/test_dotnet_skills.py --api-base https://localhost:7100
  python3 apps/Aevatar.Trading/scripts/test_dotnet_skills.py --api-base https://localhost:7100 --include-dangerous
...
ROOT = Path(__file__).resolve().parents[1]  # apps/Aevatar.Trading/
...
def main() -> int:
    ...
    ap.add_argument("--json-out", default=str(ROOT / "skill-test-report.json"),
                    help="Write JSON report to this path (default: apps/Aevatar.Trading/skill-test-report.json)")
