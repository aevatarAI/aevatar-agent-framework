...
//  - 计算 SHA-1（文本或文件）
// ============================================================
public sealed class HashSha1Tool : AevatarToolBase
{
    private readonly FileToolOptions _options;

    public HashSha1Tool(FileToolOptions options)
    {
        _options = options ?? FileToolOptions.Empty;
    }

    public override string Name => "hash_sha1";
    public override string Description => "Compute SHA-1 hash of text or file.";
