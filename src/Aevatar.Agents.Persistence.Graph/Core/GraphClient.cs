...
{
    private readonly IGraphCompiler<CypherCommand> _compiler;
    private readonly IGraphExecutor<CypherCommand> _executor;
    ...
    public GraphClient(
        IGraphCompiler<CypherCommand> compiler,
        IGraphExecutor<CypherCommand> executor)
    {
        _compiler = compiler;
        _executor = executor;
    }
