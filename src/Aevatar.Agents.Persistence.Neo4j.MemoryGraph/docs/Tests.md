# Aevatar.Agents.Persistence.Neo4j.MemoryGraph — Tests（覆盖面评审）
...
| AI/LLM | 适用 | ✅ 已覆盖（至少有相关测试） | `test/Aevatar.Agents.Core.Tests/Memory/FileMemoryVectorIndexTests.cs`, `test/Aevatar.Agents.Core.Tests/Fixtures/CoreTestFixture.cs` |
| 工具调用 | 不适用 | N/A | — |
