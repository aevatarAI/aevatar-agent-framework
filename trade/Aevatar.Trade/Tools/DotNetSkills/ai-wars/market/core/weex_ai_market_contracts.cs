/*aevatar_tool
{
  "name": "weex_ai_market_contracts",
  "description": "WEEX AI Wars MARKET API: GET /capi/v2/market/contracts (docs: https://www.weex.com/api-doc/contract/Market_API/GetContractInfo)",
  "category": "Custom",
  "version": "0.1.0",
  "tags": [
    "weex",
...
const string requestPath = "/capi/v2/market/contracts";
var method = "GET";
