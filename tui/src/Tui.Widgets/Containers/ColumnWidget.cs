...
public sealed class ColumnWidget : IWidget, IWidgetContainer
{
    private readonly List<WidgetSlot> _children = new();

    public ColumnWidget(IEnumerable<WidgetSlot> children)
    {
    ...
    public void Render(WidgetRenderContext context)
    {
        ...
        var rects = FlexLayout.Layout(context.Bounds, FlexDirection.Column, layouts);
