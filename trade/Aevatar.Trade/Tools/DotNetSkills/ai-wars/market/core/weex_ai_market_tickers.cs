/*aevatar_tool
{
  "name": "weex_ai_market_tickers",
  "description": "WEEX AI Wars MARKET API: GET /capi/v2/market/tickers (docs: https://www.weex.com/api-doc/contract/Market_API/GetAllTickerInfo)",
  "category": "Custom",
  "version": "0.1.0",
  "tags": [
    "weex",
...
const string requestPath = "/capi/v2/market/tickers";
var method = "GET";
