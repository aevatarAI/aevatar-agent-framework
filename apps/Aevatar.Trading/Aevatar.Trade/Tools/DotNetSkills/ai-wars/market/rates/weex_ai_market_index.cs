/*aevatar_tool
{
  "name": "weex_ai_market_index",
  "description": "WEEX AI Wars MARKET API: GET /capi/v2/market/index (docs: https://www.weex.com/api-doc/contract/Market_API/GetCurrencyIndex)",
  "category": "Custom",
  "version": "0.1.0",
  "tags": [
    "weex",
  ...
  "parameters": {
    ...
    "items": {
      ...
      "priceType": {
        "type": "string",
        "required": false,
        "description": "Price Type :  MARK mark; INDEX index;\nINDEX by default"
      }
    }
  }
}
...
const string requestPath = "/capi/v2/market/index";
var method = "GET";

var allParams = new[] { "symbol", "priceType" };
