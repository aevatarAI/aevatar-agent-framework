...
namespace Aevatar.Agents.Cognitive.Researching.Goals;

// ============================================================
//  GoalsStore (File-SSoT)
//
...
// ============================================================
public sealed class GoalsStore
{
    ...
    private readonly ILogger<GoalsStore> _logger;

    public GoalsStore(WorkspaceService workspace, ILogger<GoalsStore> logger)
    {
