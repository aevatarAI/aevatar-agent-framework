...
public sealed class TraceStoreTests
{
    ...
    public async Task AppendAsync_ShouldWriteTraceJsonl_AndSummaryMd()
    {
        ...
        try
        {
            ...
            var env = new TestHostEnvironment(Path.Combine(root, "src", "ScientificResearchAssistant.Api"));
    ...
    private static string CreateTempSystemRoot()
    {
        ...
        Directory.CreateDirectory(Path.Combine(root, "src", "ScientificResearchAssistant.Api"));
        return root;
    }
    ...
    private sealed class TestHostEnvironment : IHostEnvironment
    {
        ...
        public string ApplicationName { get; set; } = "ScientificResearchAssistant.Tests";
