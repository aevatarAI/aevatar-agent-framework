...
public sealed class PivotOrchestrator : IPivotOrchestrator
{
    ...
    /// <inheritdoc />
    public async Task<object> RollbackToPivotAsync(
        string sessionId,
        string pivotId,
        ...
        CancellationToken ct = default)
    {
        ...
        return await _snapshotManager.ExecuteRollbackAsync(request, ct);
    }
        ...
        CancellationToken ct = default)
    {
        ...
        {
            SessionId = sessionId,
            PivotId = string.Empty, // Empty pivotId means "most recent"
            PreserveNewCompleted = preserveNewCompleted
        };
