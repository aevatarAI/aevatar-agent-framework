...
namespace Aevatar.Notebook.Api.AgUi;

// ============================================================
//  Notebook AG-UI Bootstrap (Snapshot-first reconnect)
//
//  WHY:
//  - SSE reconnect should not replay token/progress spam.
//  - Instead, send deterministic snapshots:
//    - MESSAGES_SNAPSHOT: last N messages from AIGAgentBase.State.History
// ============================================================

internal static class NotebookAgUiBootstrap
{
        ...
        CancellationToken ct)
    {
        ...
        for (var i = 0; i < slice.Count; i++)
        {
            ...
            // Optional: expose reasoning_content to the UI as a custom side channel (best-effort).
            // We intentionally do NOT mix it into Content to avoid confusing "final answer" rendering.
        }
