/*aevatar_tool
{
  "name": "weex_ai_market_current_fund_rate",
  "description": "WEEX AI Wars MARKET API: GET /capi/v2/market/currentFundRate (docs: https://www.weex.com/api-doc/contract/Market_API/GetCurrentFundRate)",
  "category": "Custom",
  "version": "0.1.0",
  "tags": [
    "weex",
...
const string requestPath = "/capi/v2/market/currentFundRate";
var method = "GET";
