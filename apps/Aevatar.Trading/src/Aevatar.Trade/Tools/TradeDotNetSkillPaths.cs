...
public static class TradeDotNetSkillPaths
{
    ...
    private static string Resolve(string relativePath)
    {
        ...
        var fromCwd = Path.Combine(Directory.GetCurrentDirectory(), "apps", "Aevatar.Trading", "Aevatar.Trade", "Tools", "DotNetSkills", relativePath);
    ...
    private static IReadOnlyList<string> EnumerateUnder(string relativeDir)
    {
        ...
        var fromCwd = Path.Combine(Directory.GetCurrentDirectory(), "apps", "Aevatar.Trading", "Aevatar.Trade", "Tools", "DotNetSkills", relativeDir);
