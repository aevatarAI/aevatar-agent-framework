...
#
#  USAGE:
#    ./notebook/start.sh           # api (serves legacy NotebookLM-like UI)
#    ./notebook/start.sh --no-kill # do not kill ports before start
#
#  NOTES:
...
usage() {
  cat <<'EOF'
Usage: ./notebook/start.sh [--no-kill]
...
API_PROJECT="${REPO_ROOT}/notebook/src/Aevatar.Notebook.Api/Aevatar.Notebook.Api.csproj"
