/*aevatar_tool
{
  "name": "weex_ai_order_cancel_all_orders",
  "description": "WEEX AI Wars TRADE API: POST /capi/v2/order/cancelAllOrders (docs: https://www.weex.com/api-doc/contract/Transaction_API/CancelAllOrders)",
  "category": "Custom",
  "version": "0.1.0",
  "tags": [
    "weex",
  ...
  "parameters": {
    ...
    "items": {
      "symbol": {
        "type": "string",
        "required": false,
        "description": "Trading pair. If not provided, orders for all trading pairs will be cancelled"
      },
      "cancelOrderType": {
        "type": "string",
        "required": true,
...
var required = new[] { "cancelOrderType" };
EnsureRequired(root, required);

const string requestPath = "/capi/v2/order/cancelAllOrders";
var method = "POST";

var allParams = new[] { "symbol", "cancelOrderType" };
